...
public class EsotericTokenRightclickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		}.getItemStack(40, entity)).getItem() == ApotheosisReforgeTokenModItems.ESOTERIC_TOKEN.get()) {
											...
											ApotheosisReforgeTokenMod.queueServerWork(20, () -> {
												if ((new Object() {
													...
													if (entity instanceof Player _player) {
														ItemStack _stktoremove = new ItemStack(ApotheosisReforgeTokenModItems.ESOTERIC_TOKEN.get());
													...
													}
													{
														...
														if (!_ent.level().isClientSide() && _ent.getServer() != null) {
															_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(),
																	...
																	"apoth lootify apotheotic_additions:esoteric");
														}
													}
												} else {
													if (entity instanceof Player _player && !_player.level().isClientSide())
