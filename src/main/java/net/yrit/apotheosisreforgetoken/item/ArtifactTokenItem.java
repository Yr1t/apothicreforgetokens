...
import net.yrit.apotheosisreforgetoken.procedures.ArtifactTokenRightclickedProcedure;
...
public class ArtifactTokenItem extends Item {
	public ArtifactTokenItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ArtifactTokenRightclickedProcedure.execute(world, entity);
		return ar;
	}
}
