...
import net.yrit.apotheosisreforgetoken.procedures.EsotericTokenRightclickedProcedure;
...
public class EsotericTokenItem extends Item {
	public EsotericTokenItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EsotericTokenRightclickedProcedure.execute(world, entity);
		return ar;
	}
}
