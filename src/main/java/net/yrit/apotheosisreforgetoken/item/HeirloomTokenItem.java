...
import net.yrit.apotheosisreforgetoken.procedures.HeirloomTokenRightclickedProcedure;
...
public class HeirloomTokenItem extends Item {
	public HeirloomTokenItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		HeirloomTokenRightclickedProcedure.execute(world, entity);
		return ar;
	}
}
